...
## ⚡ Niche Superpowers & Technical Stack
...
## 🏥 About the Author
I am a Principal Enterprise Data & Supply Chain Consultant specializing in business transformation, legacy system modernization, and data governance. I combine decades of deep database table engineering with modern cloud analytics to give corporate executives real-time, visual clarity over global supply networks.

*   **Looking for:** Senior Consulting & Advisory opportunities in the Florida, California, New York/New Jersey, or Washington markets
...
### Dataset Setup
Download the following datasets from Kaggle and place them in the project root directory:
